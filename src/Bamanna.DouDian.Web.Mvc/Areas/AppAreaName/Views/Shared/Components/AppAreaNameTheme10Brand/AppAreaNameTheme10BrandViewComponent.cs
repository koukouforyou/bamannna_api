...
namespace Bamanna.DouDian.Web.Areas.AppAreaName.Views.Shared.Components.AppAreaNameTheme10Brand
{
    public class AppAreaNameTheme10BrandViewComponent : DouDianViewComponent
    {
