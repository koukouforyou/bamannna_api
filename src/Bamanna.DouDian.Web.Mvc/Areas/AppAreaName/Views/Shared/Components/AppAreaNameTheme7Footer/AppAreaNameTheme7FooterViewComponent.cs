...
namespace Bamanna.DouDian.Web.Areas.AppAreaName.Views.Shared.Components.AppAreaNameTheme7Footer
{
    public class AppAreaNameTheme7FooterViewComponent : DouDianViewComponent
    {
