...
namespace Bamanna.DouDian.Web.Areas.AppAreaName.Views.Shared.Components.AppAreaNameTheme3Footer
{
    public class AppAreaNameTheme3FooterViewComponent : DouDianViewComponent
    {
