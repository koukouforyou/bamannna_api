...
namespace Bamanna.DouDian.Web.Areas.AppAreaName.Views.Shared.Components.AppAreaNameTheme6Footer
{
    public class AppAreaNameTheme6FooterViewComponent : DouDianViewComponent
    {
