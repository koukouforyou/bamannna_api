...
namespace Bamanna.DouDian.Web.Areas.AppAreaName.Views.Shared.Components.AppAreaNameTheme4Footer
{
    public class AppAreaNameTheme4FooterViewComponent : DouDianViewComponent
    {
