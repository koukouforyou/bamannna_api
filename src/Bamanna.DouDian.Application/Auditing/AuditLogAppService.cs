...
using Bamanna.DouDian.Auditing.Exporting;
...
using EntityHistoryHelper = Bamanna.DouDian.EntityHistory.EntityHistoryHelper;

namespace Bamanna.DouDian.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : DouDianAppServiceBase, IAuditLogAppService
    {
