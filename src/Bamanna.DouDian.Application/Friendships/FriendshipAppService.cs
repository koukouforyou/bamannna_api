...
using Bamanna.DouDian.Friendships.Dto;

namespace Bamanna.DouDian.Friendships
{
    [AbpAuthorize]
    public class FriendshipAppService : DouDianAppServiceBase, IFriendshipAppService
    {
