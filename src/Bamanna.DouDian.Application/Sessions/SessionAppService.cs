...
{
    public class SessionAppService : DouDianAppServiceBase, ISessionAppService
    {
        ...
        public async Task<GetCurrentLoginInformationsOutput> GetCurrentLoginInformations()
        {
            var output = new GetCurrentLoginInformationsOutput
            {
                Application = new ApplicationInfoDto
                {
                    ...
                    Currency = DouDianConsts.Currency,
                    CurrencySign = DouDianConsts.CurrencySign,
                    AllowTenantsToChangeEmailSettings = DouDianConsts.AllowTenantsToChangeEmailSettings
                }
            };
