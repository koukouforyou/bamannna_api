...
{
    public class AbpDouDianClient : ISingletonDependency, IDisposable
    {
        ...
        {
            _client = new FlurlClient(DouDianUrlConfig.BaseUrl);
        ...
        private void AddHeaders(string accessToken)
        {
            ...
            _client.WithHeader("User-Agent", DouDianConsts.AbpDouDianClientUserAgent);
