...
namespace Bamanna.DouDian.MultiTenancy.Payments.Stripe
{
    ...
    public class StripeGatewayManager : DouDianServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "DouDian";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + DouDianConsts.Currency;
        }
