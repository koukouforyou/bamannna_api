...
namespace Bamanna.DouDian.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : DouDianServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("Bamanna.DouDian", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
