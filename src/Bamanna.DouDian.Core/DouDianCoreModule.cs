...
using Bamanna.DouDian.Friendships.Cache;
using Bamanna.DouDian.Localization;
using Bamanna.DouDian.MultiTenancy;
using Bamanna.DouDian.Net.Emailing;
...
namespace Bamanna.DouDian
{
    ...
    public class DouDianCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            DouDianLocalizationConfigurer.Configure(Configuration.Localization);
            ...
            Configuration.MultiTenancy.IsEnabled = DouDianConsts.MultiTenancyEnabled;
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, DouDianMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<DouDianSmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(DouDianCoreModule).GetAssembly());
        }
