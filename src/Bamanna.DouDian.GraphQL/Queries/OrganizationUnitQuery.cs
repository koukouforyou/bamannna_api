...
using Bamanna.DouDian.Core.Base;
using Bamanna.DouDian.Core.Extensions;
using Bamanna.DouDian.Dto;
using Bamanna.DouDian.Types;

namespace Bamanna.DouDian.Queries
{
    public class OrganizationUnitQuery : DouDianQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
