...
namespace Bamanna.DouDian.Core.Base
{
    public abstract class DouDianQueryBase<TField,TResult> : ITransientDependency
    {
        ...
        protected DouDianQueryBase(string fieldName,
