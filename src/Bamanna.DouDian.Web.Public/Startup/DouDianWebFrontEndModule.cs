...
namespace Bamanna.DouDian.Web.Public.Startup
{
    ...
    public class DouDianWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public DouDianWebFrontEndModule(IHostingEnvironment env, DouDianEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(DouDianWebFrontEndModule).GetAssembly());
        }
    }
}
