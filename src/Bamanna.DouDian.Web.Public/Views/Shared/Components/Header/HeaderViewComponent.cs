...
using Bamanna.DouDian.Web.Public.Startup;
using Bamanna.DouDian.Web.Session;

namespace Bamanna.DouDian.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : DouDianViewComponent
    {
