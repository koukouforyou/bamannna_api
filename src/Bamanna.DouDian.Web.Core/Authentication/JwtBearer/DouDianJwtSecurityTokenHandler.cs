...
namespace Bamanna.DouDian.Web.Authentication.JwtBearer
{
    public class DouDianJwtSecurityTokenHandler : ISecurityTokenValidator
    {
        private readonly JwtSecurityTokenHandler _tokenHandler;

        public DouDianJwtSecurityTokenHandler()
        {
