...
using Bamanna.DouDian.Services.Navigation;
...
using Bamanna.DouDian.Controls;
using Bamanna.DouDian.Dto;
using Bamanna.DouDian.Extensions;
using Bamanna.DouDian.Localization;
using Bamanna.DouDian.UI;
using Bamanna.DouDian.UI.Assets;
using Bamanna.DouDian.Views;
using DependencyResolver = Bamanna.DouDian.Core.Dependency.DependencyResolver;
...
namespace Bamanna.DouDian.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "DouDian";
