...
using Bamanna.DouDian.EntityFrameworkCore.Repositories;

namespace Bamanna.DouDian.MultiTenancy.Payments
{
    public class SubscriptionPaymentRepository : DouDianRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<DouDianDbContext> dbContextProvider)
