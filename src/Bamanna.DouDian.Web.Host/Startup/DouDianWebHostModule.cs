...
{
    [DependsOn(
        typeof(DouDianWebCoreModule)
    )]
    public class DouDianWebHostModule : AbpModule
    {
        private readonly IHostingEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public DouDianWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(DouDianWebHostModule).GetAssembly());
        }
