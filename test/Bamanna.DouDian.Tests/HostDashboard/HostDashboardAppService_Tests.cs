...
using Bamanna.DouDian.MultiTenancy.HostDashboard;
...
namespace Bamanna.DouDian.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(DouDianDbContext context, SubscriptionPayment subscriptionPayment)
        {
