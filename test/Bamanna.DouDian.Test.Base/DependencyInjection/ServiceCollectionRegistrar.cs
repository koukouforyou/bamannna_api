...
namespace Bamanna.DouDian.Test.Base.DependencyInjection
{
    public static class ServiceCollectionRegistrar
    {
        public static void Register(IIocManager iocManager)
        {
            ...
            iocManager.IocContainer.Register(
                Component
                    .For<DbContextOptions<DouDianDbContext>>()
            ...
            new DouDianDbContext(builder.Options).Database.EnsureCreated();
        }
